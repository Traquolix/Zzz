...
6. [ ] **Frontend: poll section history API** [#54] — enhancement, replace client-side accumulation with periodic API polling
7. [ ] **Consolidate dual Incident type definitions** [#42] — refactor, prototype vs canonical
8. [ ] **Sim stats: `detectionsPerSecond` always 0** [#41] — enhancement
9. [ ] **Optimistic flow switch rollback** [#15] — bug, frontend/backend flow state desync
