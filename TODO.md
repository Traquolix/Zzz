...
15. [x] **Make 3D vehicle popups to track their values on click**
...
19. [ ] **Add new infrastructures to populate the shm list. No need for actual data behind**
20. [ ] **Install self-hosted GitHub Actions runners** [#5] — prerequisite for automated deploys
21. [ ] **Real-time SHM data** [#11] — end-to-end SHM data flow (pipeline → simulation → frontend)
