...
DROP VIEW IF EXISTS sequoia.fiber_speed_data_1s_promenade_mv;
DROP TABLE IF EXISTS sequoia.fiber_speed_data_1s_promenade;
DROP VIEW IF EXISTS sequoia.fiber_speed_data_1s_carros_mv;
...
DROP TABLE IF EXISTS sequoia.fiber_speed_data_1h;
DROP VIEW IF EXISTS sequoia.fiber_speed_data_30m_mv;
DROP TABLE IF EXISTS sequoia.fiber_speed_data_30m;
DROP VIEW IF EXISTS sequoia.fiber_speed_data_5m_mv;
DROP TABLE IF EXISTS sequoia.fiber_speed_data_5m;
DROP VIEW IF EXISTS sequoia.fiber_speed_data_1m_mv;
DROP TABLE IF EXISTS sequoia.fiber_speed_data_1m;
...
DROP VIEW IF EXISTS sequoia.speed_points_mv;
DROP TABLE IF EXISTS sequoia.fiber_speed_data;

-- Drop old per-fiber count tables
DROP VIEW IF EXISTS sequoia.fiber_count_data_1s_promenade_mv;
DROP TABLE IF EXISTS sequoia.fiber_count_data_1s_promenade;
DROP VIEW IF EXISTS sequoia.fiber_count_data_1s_carros_mv;
...
DROP TABLE IF EXISTS sequoia.fiber_vehicle_counts_1h;
DROP VIEW IF EXISTS sequoia.fiber_vehicle_counts_30m_mv;
DROP TABLE IF EXISTS sequoia.fiber_vehicle_counts_30m;
DROP VIEW IF EXISTS sequoia.fiber_vehicle_counts_5m_mv;
DROP TABLE IF EXISTS sequoia.fiber_vehicle_counts_5m;
DROP VIEW IF EXISTS sequoia.fiber_vehicle_counts_1m_mv;
DROP TABLE IF EXISTS sequoia.fiber_vehicle_counts_1m;
...
DROP VIEW IF EXISTS sequoia.vehicle_counts_mv;
DROP TABLE IF EXISTS sequoia.fiber_vehicle_counts;
