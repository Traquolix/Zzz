...
urlpatterns = [
    ...
    path('monitoring/shm/status/<str:infrastructure_id>', monitoring_views.SHMStatusView.as_view(), name='shm-status'),
    ...
    path('reports/schedules', reporting_views.ReportScheduleListView.as_view(), name='report-schedules'),
    path('reports/schedules/<uuid:schedule_id>', reporting_views.ReportScheduleDetailView.as_view(), name='report-schedule-detail'),
    ...
    path('admin/organizations/<uuid:org_id>', admin_views.OrganizationDetailView.as_view(), name='admin-organization-detail'),
    path('admin/organizations/<uuid:org_id>/settings', admin_views.OrgSettingsView.as_view(), name='admin-org-settings'),
    path('admin/organizations/<uuid:org_id>/fibers', admin_views.FiberAssignmentListView.as_view(), name='admin-fiber-assignments'),
    path('admin/organizations/<uuid:org_id>/fibers/<uuid:assignment_id>', admin_views.FiberAssignmentDetailView.as_view(), name='admin-fiber-assignment-detail'),
    path('admin/users', admin_views.UserListView.as_view(), name='admin-users'),
    path('admin/users/<uuid:user_id>', admin_views.UserDetailView.as_view(), name='admin-user-detail'),
    path('admin/infrastructure', admin_views.InfrastructureAdminListView.as_view(), name='admin-infrastructure'),
    path('admin/infrastructure/<str:infra_id>', admin_views.InfrastructureAdminDetailView.as_view(), name='admin-infrastructure-detail'),
    path('admin/alert-rules', admin_views.AlertRuleListView.as_view(), name='admin-alert-rules'),
    path('admin/alert-rules/<uuid:rule_id>', admin_views.AlertRuleDetailView.as_view(), name='admin-alert-rule-detail'),
    path('admin/alert-rules/<uuid:rule_id>/test', admin_views.AlertRuleTestView.as_view(), name='admin-alert-rule-test'),
    ...
    path('admin/api-keys/<uuid:key_id>', admin_views.APIKeyDetailView.as_view(), name='admin-api-key-detail'),
    path('admin/api-keys/<uuid:key_id>/rotate', admin_views.APIKeyRotateView.as_view(), name='admin-api-key-rotate'),
]
