...
class TestEnsureDirectionalFiberId:
    ...
    def test_complex_fiber_id_with_hyphens(self):
        assert _ensure_directional_fiber_id('fiber-promenade-des-anglais') == 'fiber-promenade-des-anglais:0'
...
class TestTransformSimulationIncident:
    ...
    def test_detected_at_passes_through(self):
        result = transform_simulation_incident(self._FakeIncident(detected_at='2025-01-01T00:00:00Z'))
