...
class TestIncidentActionAPI(TestCase):
    ...
    def test_nonexistent_incident_returns_404(self, mock_query):
        ...
        resp = self.client.post(
            "/api/incidents/inc-ghost/actions",
            {
                "action": "acknowledged",
            },
            format="json",
