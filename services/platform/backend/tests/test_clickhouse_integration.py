...
class TestIncidentQueriesReal:
    ...
    def test_query_active_returns_only_active_incidents(self, clickhouse):
        clickhouse.seed_incidents([
            {
                'incident_id': 'inc-active', 'fiber_id': 'carros',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 500, 'channel_end': 550,
                'incident_type': 'congestion', 'severity': 'medium',
                'status': 'active', 'duration_seconds': 120,
            },
            {
                'incident_id': 'inc-resolved', 'fiber_id': 'carros',
                'timestamp_ns': _ts(hours_ago=2),
                'channel_start': 100, 'channel_end': 150,
                'incident_type': 'accident', 'severity': 'high',
                'status': 'resolved', 'duration_seconds': 300,
            },
        ])
    ...
    def test_query_active_org_scoping_excludes_other_fibers(self, clickhouse):
        clickhouse.seed_incidents([
            {
                'incident_id': 'inc-carros', 'fiber_id': 'carros',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 500, 'channel_end': 550,
                'incident_type': 'congestion', 'severity': 'medium',
            ...
            {
                'incident_id': 'inc-mathis', 'fiber_id': 'mathis',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 200, 'channel_end': 250,
                'incident_type': 'slowdown', 'severity': 'low',
                'status': 'active', 'duration_seconds': 30,
            },
        ])
    ...
    def test_query_active_superuser_sees_all(self, clickhouse):
        clickhouse.seed_incidents([
            {
                'incident_id': 'inc-a', 'fiber_id': 'carros',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 500, 'channel_end': 550,
                'incident_type': 'congestion', 'severity': 'medium',
                'status': 'active', 'duration_seconds': 60,
            ...
            {
                'incident_id': 'inc-b', 'fiber_id': 'mathis',
                'timestamp_ns': _ts(hours_ago=2),
                'channel_start': 200, 'channel_end': 250,
                'incident_type': 'slowdown', 'severity': 'low',
                'status': 'active', 'duration_seconds': 30,
    ...
    def test_query_active_respects_limit(self, clickhouse):
        for i in range(10):
            clickhouse.seed_incidents([{
                'incident_id': f'inc-{i:03d}', 'fiber_id': 'carros',
                'timestamp_ns': _ts(minutes_ago=i),
                'channel_start': 500 + i, 'channel_end': 550 + i,
                'incident_type': 'congestion', 'severity': 'medium',
                'status': 'active', 'duration_seconds': 60,
            }])
    ...
    def test_query_active_ordered_by_timestamp_desc(self, clickhouse):
        clickhouse.seed_incidents([
            {
                'incident_id': 'inc-old', 'fiber_id': 'carros',
            ...
            {
                'incident_id': 'inc-new', 'fiber_id': 'carros',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 800, 'channel_end': 850,
                'incident_type': 'slowdown', 'severity': 'low',
                'status': 'active', 'duration_seconds': 30,
            },
        ])
    ...
    def test_query_active_empty_fiber_list_returns_empty(self, clickhouse):
        clickhouse.seed_incidents([{
            'incident_id': 'inc-1', 'fiber_id': 'carros',
            'timestamp_ns': _ts(hours_ago=1),
            'channel_start': 500, 'channel_end': 550,
            'incident_type': 'congestion', 'severity': 'medium',
            'status': 'active', 'duration_seconds': 60,
...
class TestFinalDeduplication:
    ...
    def test_updated_incident_shows_latest_status(self, clickhouse):
        ...
        ts = _ts(hours_ago=2)
        clickhouse.seed_incidents([{
            'incident_id': 'inc-dup', 'fiber_id': 'carros',
            'timestamp_ns': ts,
            'channel_start': 500, 'channel_end': 550,
            'incident_type': 'congestion', 'severity': 'medium',
            'status': 'active', 'duration_seconds': 60,
    ...
    def test_without_final_both_versions_visible(self, clickhouse):
        ...
        ts = _ts(hours_ago=1)
        clickhouse.seed_incidents([{
            'incident_id': 'inc-dup2', 'fiber_id': 'carros',
            'timestamp_ns': ts,
            'channel_start': 300, 'channel_end': 350,
            'incident_type': 'slowdown', 'severity': 'low',
            'status': 'active', 'duration_seconds': 30,
        }])
...
class TestStatsQueriesReal:
    ...
    def test_fiber_count_scoped(self, clickhouse):
        clickhouse.seed_fiber_cables([
            {'fiber_id': 'carros', 'fiber_name': 'Carros', 'channel_coordinates': [(43.7, 7.2)] * 100},
            {'fiber_id': 'mathis', 'fiber_name': 'Mathis', 'channel_coordinates': [(43.8, 7.3)] * 200},
            {'fiber_id': 'promenade', 'fiber_name': 'Promenade', 'channel_coordinates': [(43.9, 7.4)] * 300},
        ])
    ...
    def test_total_channels_scoped(self, clickhouse):
        clickhouse.seed_fiber_cables([
            {'fiber_id': 'carros', 'fiber_name': 'Carros', 'channel_coordinates': [(43.7, 7.2)] * 1000},
            {'fiber_id': 'mathis', 'fiber_name': 'Mathis', 'channel_coordinates': [(43.8, 7.3)] * 500},
            {'fiber_id': 'promenade', 'fiber_name': 'Promenade', 'channel_coordinates': [(43.9, 7.4)] * 2000},
        ])
    ...
    def test_active_incident_count_scoped(self, clickhouse):
        clickhouse.seed_incidents([
            {
                'incident_id': 'inc-a1', 'fiber_id': 'carros',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 500, 'channel_end': 550,
                'incident_type': 'congestion', 'severity': 'medium',
                'status': 'active', 'duration_seconds': 60,
            ...
            {
                'incident_id': 'inc-a2', 'fiber_id': 'carros',
                'timestamp_ns': _ts(hours_ago=2),
                'channel_start': 800, 'channel_end': 850,
                'incident_type': 'slowdown', 'severity': 'low',
                'status': 'active', 'duration_seconds': 30,
            ...
            {
                'incident_id': 'inc-m1', 'fiber_id': 'mathis',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 200, 'channel_end': 250,
                'incident_type': 'accident', 'severity': 'high',
                'status': 'active', 'duration_seconds': 300,
            },
        ])
...
class TestSnapshotQueriesReal:
    ...
    def test_incident_lookup_by_id(self, clickhouse):
        ts = _ts(hours_ago=1)
        clickhouse.seed_incidents([{
            'incident_id': 'snap-001', 'fiber_id': 'carros',
            'timestamp_ns': ts,
            'channel_start': 500, 'channel_end': 550,
            'incident_type': 'congestion', 'severity': 'medium',
            'status': 'active', 'duration_seconds': 120,
    ...
    def test_speed_hires_channel_windowing(self, clickhouse):
        ...
        for ch in range(480, 561):
            clickhouse.seed_speed_hires([{
                'fiber_id': 'carros', 'ts': ts_str,
                'ch': ch, 'speed': 80.0 + ch * 0.1,
            }])
...
class TestIncidentListViewIntegration:
    ...
    def test_returns_incidents_from_assigned_fibers(
        self, clickhouse, authenticated_client, fiber_assignments,
    ):
        clickhouse.seed_incidents([{
            'incident_id': 'api-inc-1', 'fiber_id': 'carros',
            'timestamp_ns': _ts(hours_ago=1),
            'channel_start': 500, 'channel_end': 550,
            'incident_type': 'congestion', 'severity': 'medium',
            'status': 'active', 'duration_seconds': 120,
    ...
    def test_excludes_incidents_from_unassigned_fibers(
        ...
        clickhouse.seed_incidents([
            {
                'incident_id': 'inc-visible', 'fiber_id': 'carros',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 500, 'channel_end': 550,
                'incident_type': 'congestion', 'severity': 'medium',
                'status': 'active', 'duration_seconds': 60,
            ...
            {
                'incident_id': 'inc-hidden', 'fiber_id': 'secret_fiber',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 100, 'channel_end': 150,
                'incident_type': 'accident', 'severity': 'high',
                'status': 'active', 'duration_seconds': 300,
    ...
    def test_pagination_has_more(
        ...
        for i in range(15):
            clickhouse.seed_incidents([{
                'incident_id': f'page-{i:03d}', 'fiber_id': 'carros',
                'timestamp_ns': _ts(minutes_ago=i),
                'channel_start': 500 + i, 'channel_end': 550 + i,
                'incident_type': 'congestion', 'severity': 'medium',
                'status': 'active', 'duration_seconds': 60,
    ...
    def test_pagination_no_more(
        ...
        clickhouse.seed_incidents([{
            'incident_id': 'only-one', 'fiber_id': 'carros',
            'timestamp_ns': _ts(hours_ago=1),
            'channel_start': 500, 'channel_end': 550,
            'incident_type': 'congestion', 'severity': 'medium',
            'status': 'active', 'duration_seconds': 60,
    ...
    def test_superuser_sees_all_fibers(
        self, clickhouse, superuser_client, fiber_assignments,
    ):
        clickhouse.seed_incidents([
            {
                'incident_id': 'su-1', 'fiber_id': 'carros',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 500, 'channel_end': 550,
                'incident_type': 'congestion', 'severity': 'medium',
                'status': 'active', 'duration_seconds': 60,
            ...
            {
                'incident_id': 'su-2', 'fiber_id': 'secret_fiber',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 100, 'channel_end': 150,
                'incident_type': 'accident', 'severity': 'high',
                'status': 'active', 'duration_seconds': 300,
    ...
    def test_other_org_cannot_see_first_org_incidents(
        self, clickhouse, other_org_client, other_org_fiber_assignments,
    ):
        """other_org has only 'carros'. Incident on 'mathis' should not appear."""
        clickhouse.seed_incidents([
            {
                'incident_id': 'cross-1', 'fiber_id': 'carros',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 500, 'channel_end': 550,
                'incident_type': 'congestion', 'severity': 'medium',
                'status': 'active', 'duration_seconds': 60,
            ...
            {
                'incident_id': 'cross-2', 'fiber_id': 'mathis',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 200, 'channel_end': 250,
                'incident_type': 'slowdown', 'severity': 'low',
                'status': 'active', 'duration_seconds': 30,
...
class TestStatsViewIntegration:
    ...
    def test_stats_fiber_count_matches_assigned(
        ...
        clickhouse.seed_fiber_cables([
            ...
            {'fiber_id': 'mathis', 'fiber_name': 'Mathis', 'channel_coordinates': [(43.8, 7.3)] * 500},
            {'fiber_id': 'promenade', 'fiber_name': 'Promenade', 'channel_coordinates': [(43.9, 7.4)] * 2000},
            {'fiber_id': 'secret', 'fiber_name': 'Secret', 'channel_coordinates': [(44.0, 7.5)] * 100},
        ])
    ...
    def test_stats_active_incidents_count(
        ...
        clickhouse.seed_incidents([
            {
                'incident_id': 'stat-1', 'fiber_id': 'carros',
                'timestamp_ns': _ts(hours_ago=1),
                'channel_start': 500, 'channel_end': 550,
                'incident_type': 'congestion', 'severity': 'medium',
                'status': 'active', 'duration_seconds': 60,
            ...
            {
                'incident_id': 'stat-2', 'fiber_id': 'carros',
                'timestamp_ns': _ts(hours_ago=2),
                'channel_start': 800, 'channel_end': 850,
                'incident_type': 'slowdown', 'severity': 'low',
                'status': 'resolved', 'duration_seconds': 30,
            },
        ])
...
class TestSnapshotViewIntegration:
    ...
    def test_snapshot_returns_speed_data_around_incident(
        ...
        clickhouse.seed_incidents([{
            'incident_id': 'snap-view-1', 'fiber_id': 'carros',
            'timestamp_ns': _ts(hours_ago=1),
            'channel_start': 500, 'channel_end': 550,
            'incident_type': 'congestion', 'severity': 'medium',
            'status': 'active', 'duration_seconds': 120,
    ...
    def test_snapshot_404_for_other_orgs_fiber(
        ...
        clickhouse.seed_incidents([{
            'incident_id': 'snap-cross', 'fiber_id': 'mathis',
            'timestamp_ns': _ts(hours_ago=1),
            'channel_start': 200, 'channel_end': 250,
            'incident_type': 'accident', 'severity': 'high',
            'status': 'active', 'duration_seconds': 300,
...
class TestCountHiresMVIntegrity:
    ...
    def test_count_1m_preserves_ch_end_differentiation(self, clickhouse):
        ...
        for i in range(5):
            clickhouse.seed_count_hires([
                {'fiber_id': 'carros', 'ts': ts_str, 'ch_start': 100, 'ch_end': 200, 'count': 2.0},
                {'fiber_id': 'carros', 'ts': ts_str, 'ch_start': 100, 'ch_end': 300, 'count': 3.0},
            ])
