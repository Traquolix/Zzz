...
describe('EmptyState', () => {
  ...
  it('renders optional icon', () => {
    render(<EmptyState icon={<Info data-testid="test-icon" />} title="No items" />)
  ...
  it('renders optional action', () => {
    render(<EmptyState title="No items" action={<button data-testid="action-btn">Create Item</button>} />)
  ...
  it('icon container has correct styling', () => {
    const { container } = render(<EmptyState icon={<Info />} title="No items" />)
    const iconContainer = container.querySelector('.mb-4')
  ...
  it('action container is positioned below description', () => {
    const { container } = render(
      <EmptyState title="No items" description="Description" action={<button>Action</button>} />,
    )
