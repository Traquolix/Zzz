        ...
        return (
          <button
            ...
            className={cn(
              ...
              active && 'bg-[var(--dash-surface-raised)] text-[var(--dash-text)]',
              !active && !disabled && 'text-[var(--dash-text-secondary)] hover:text-[var(--dash-text)]',
              disabled && !switchingFlow && 'text-[var(--dash-text-muted)] opacity-40 cursor-not-allowed',
