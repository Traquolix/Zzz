          ...
          return (
            <div
              ...
              style={{
                ...
                animation: isTop ? 'dashToastIn 200ms ease-out' : undefined,
              }}
            >
              <button
              ...
              >
                <div className="flex items-start gap-2.5 px-3.5 py-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="text-xs text-[var(--dash-text-muted)] mt-0.5">New {toast.type} detected</div>
                  </div>
                  {isTop && toasts.length > 1 && (
                    <span className="shrink-0 text-[10px] font-semibold text-[var(--dash-text-muted)] bg-[var(--dash-base)] rounded-full px-1.5 py-0.5 mt-0.5">
                      +{toasts.length - 1}
                    </span>
                  )}
                </div>
                {/* Progress bar */}
                <div className="w-full h-0.5 bg-[var(--dash-base)]">
                  <div
