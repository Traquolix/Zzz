  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          ...
          sections.length >= MAX_SECTIONS_PER_ORG
            ? 'text-[var(--dash-text-muted)] opacity-40 cursor-not-allowed'
            : 'text-[var(--dash-text-muted)] hover:text-[var(--dash-text)] cursor-pointer',
        )}
        title={
          sections.length >= MAX_SECTIONS_PER_ORG
      ...
      <button
        ...
        className="flex items-center justify-center w-6 h-6 rounded hover:bg-[var(--dash-border)] transition-colors cursor-pointer"
