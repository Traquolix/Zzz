...
export function getSpeedColorRGBA(speed: number, opacity: number, thresholds?: SpeedThresholds): [number, number, number, number] {
...
export function buildThresholdLookup(
    ...
    for (const sec of sections) {
        ...
        if (!list) { list = []; byFiber.set(sec.fiberId, list) }
