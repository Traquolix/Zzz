...
export function Legend({ displayMode, onToggleDisplayMode, isOverview, sidebarOpen, hideFibersInOverview, onToggleHideFibers }: LegendProps) {
...
const CubeIcon = () => (
    <svg width="12" height="12" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round">
