...
function AppErrorFallback() {
    const title = i18n.t('errors.appCrash', 'Application Error')
    const message = i18n.t('errors.appCrashDescription', 'Something went wrong. Please reload the page.')
    const reloadText = i18n.t('errors.reloadPage', 'Reload Page')
